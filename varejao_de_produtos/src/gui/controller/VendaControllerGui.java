...
//		int id_venda=46;
		for(int i=0;i<items.size();i++) {
			...
			funcoes.TotalEstoqueAtualiza(items.get(i).getId_produtoref());
		}
				...
				if (event.getSource() == buttonCadastarVenda) {
					...
					try {
						...
						textField_CpfComprador.clear();
						  ...
						  dialogoInfo.setTitle("Informa��o");
				            dialogoInfo.setHeaderText("Cadastro da Venda");
			...
			public void handle(ActionEvent event) {
				...
				if (event.getSource() == buttonAddItem) {
					...
					if(resultado==1) {
			            ...
			            dialogoInfo.setContentText("O produto n�o possui quantidade suficiente no estoque");
			            dialogoInfo.showAndWait();
					}
			...
			buttonRemoverItem.setOnAction(e -> {
	          ...
	          try {
	            ...
	            if(item!= null && item instanceof Item_Venda) {
					...
					AtualizaTabela();
					 dialogoInfo.setTitle("Informa��o");
			            dialogoInfo.setHeaderText("Remo��o Item da Venda");
		            ...
		            try {
	            	 ...
	            	 Alert dialogo = new Alert(Alert.AlertType.WARNING);
					  dialogo.setTitle("Aten��o");
			            dialogo.setHeaderText("Remo��o de item");
		            ...
		            dialogoInfo.setContentText("Selecione um item para remov�-lo");
		            dialogoInfo.showAndWait();
	            }
